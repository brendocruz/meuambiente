...
local default_config = {
	mappings = {
		n = {
			['<A-1>'] = mappings.go_to_terminal(1, true),
			['<A-2>'] = mappings.go_to_terminal(2, true),
			['<A-3>'] = mappings.go_to_terminal(3, true),
			['<A-S-1>'] = mappings.go_to_terminal(1, false),
			['<A-S-2>'] = mappings.go_to_terminal(2, false),
			['<A-S-3>'] = mappings.go_to_terminal(3, false),
